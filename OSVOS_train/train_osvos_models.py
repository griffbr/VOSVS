...
def main():
	...
	for i, video_name in enumerate(video_list):
		# if i==0: video_name = 'dr' # optional fasttrack of a specific model
		# Misc. setup.
		...
		osvos_segment(image_dir, annotation_dir, result_dir, video_name, data_dir, iters=10000)
